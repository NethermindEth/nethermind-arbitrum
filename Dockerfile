...
# Fix CVE-2025-68973 - Update gpgv package; install zstd for tar.zst snapshot extraction
RUN apt-get update && \
    apt-get install -y --no-install-recommends gpgv=2.4.4-2ubuntu17.4 zstd && \
    apt-get clean && \
