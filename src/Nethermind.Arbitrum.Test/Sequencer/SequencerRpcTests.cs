...
public class SequencerRpcTests
{
    ...
    public async Task StartSequencing_ViaRpc_ReturnsResult()
    {
        ...
        ResultWrapper<StartSequencingResult> result = await rpcModule.StartSequencing(new StartSequencingParams(0, 0, 0));
    ...
    public async Task SequencerRpc_EnqueueStartAppendEndCycle_ProducesBlock()
    {
        ...
        // 2. StartSequencing
        ResultWrapper<StartSequencingResult> seqResult = await rpcModule.StartSequencing(new StartSequencingParams(0, 0, 0));
