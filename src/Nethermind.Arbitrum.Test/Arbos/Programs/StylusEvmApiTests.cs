...
public class StylusEvmApiTests
{
    ...
    public void GetBytes32_EmptySlot_ReturnsZeroPadded()
    {
        ...
        using StylusEvmApi api = new(helper.VmHost, ActingAddress, NoOpMemoryModel);
    ...
    {
        using WasmGasTestHelper helper = new();
        using StylusEvmApi api = new(helper.VmHost, Address.Zero, NoOpMemoryModel);
    ...
    public void AddPages_NonZeroPages_ReturnsGasCost()
    {
        using WasmGasTestHelper helper = new();
        ushort pageGas = 1000;
        using StylusEvmApi api = new(helper.VmHost, ActingAddress, new StylusMemoryModel(0, pageGas));
    ...
    {
        using WasmGasTestHelper helper = new();
        using StylusEvmApi api = new(helper.VmHost, ActingAddress, new StylusMemoryModel(10, 1000));
