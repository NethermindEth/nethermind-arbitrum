...
public static class TransactionExecutionExtensions
{
    ...
    /// (go-ethereum/core/vm/evm.go:BlockContext). Use for internal Arbitrum gas accounting
    ...
    /// See go-ethereum/core/state_transition.go:execute for validation,
    /// arbos/tx_processor.go:GetPaidGasPrice for where BaseFeeInBlock is consumed.
    /// </summary>
