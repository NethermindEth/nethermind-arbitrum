...
namespace Nethermind.Arbitrum.Modules
{
    ...
    public class ArbitrumEthRpcModule : EthRpcModule, IArbitrumEthRpcModule
    {
            ...
            : ArbitrumTxExecutor<HexBytes>(blockchainBridge, blockFinder, rpcConfig, originalBaseFee, chainSpecParams)
        {
            ...
            {
                CallOutput result = _blockchainBridge.Call(header, tx, stateOverride, BlobBaseFeeOverride, blockOverride: null, token);
            ...
            : ArbitrumTxExecutor<UInt256?>(blockchainBridge, blockFinder, rpcConfig, originalBaseFee, chainSpecParams)
        {
            ...
            {
                CallOutput result = _blockchainBridge.EstimateGas(header, tx, _errorMargin, stateOverride, BlobBaseFeeOverride, blockOverride: null, token);
