...
public sealed class ArbitrumInternalTxDecoder() : BaseEIP1559TxDecoder<ArbitrumInternalTransaction>((TxType)ArbitrumTxType.ArbitrumInternal)
{
    ...
    {
        return Rlp.LengthOf(transaction.ChainId) + Rlp.LengthOf(transaction.Data);
    }
...
public sealed class ArbitrumSubmitRetryableTxDecoder()
    : BaseEIP1559TxDecoder<ArbitrumSubmitRetryableTransaction>((TxType)ArbitrumTxType.ArbitrumSubmitRetryable)
{
    public override void Encode(Transaction transaction, RlpStream stream, RlpBehaviors rlpBehaviors = RlpBehaviors.None, bool forSigning = false, bool isEip155Enabled = false, ulong chainId = 0)
    {
        forSigning = true;
...
public sealed class ArbitrumRetryTxDecoder() : BaseEIP1559TxDecoder<ArbitrumRetryTransaction>((TxType)ArbitrumTxType.ArbitrumRetry)
{
    public override void Encode(Transaction transaction, RlpStream stream, RlpBehaviors rlpBehaviors = RlpBehaviors.None, bool forSigning = false, bool isEip155Enabled = false, ulong chainId = 0)
    {
        forSigning = true;
    ...
    protected override int GetPayloadLength(Transaction transaction)
    {
        ArbitrumRetryTransaction retryTx = (ArbitrumRetryTransaction)transaction;
...
public sealed class ArbitrumDepositTxDecoder() : BaseEIP1559TxDecoder<ArbitrumDepositTransaction>((TxType)ArbitrumTxType.ArbitrumDeposit)
{
    public override void Encode(Transaction transaction, RlpStream stream, RlpBehaviors rlpBehaviors = RlpBehaviors.None, bool forSigning = false, bool isEip155Enabled = false, ulong chainId = 0)
    {
        forSigning = true;
    ...
    protected override int GetPayloadLength(Transaction transaction)
    {
        ArbitrumDepositTransaction depositTx = (ArbitrumDepositTransaction)transaction;
...
public sealed class ArbitrumUnsignedTxDecoder() : BaseEIP1559TxDecoder<ArbitrumUnsignedTransaction>((TxType)ArbitrumTxType.ArbitrumUnsigned)
{
    public override void Encode(Transaction transaction, RlpStream stream, RlpBehaviors rlpBehaviors = RlpBehaviors.None, bool forSigning = false, bool isEip155Enabled = false, ulong chainId = 0)
    {
        forSigning = true;
    ...
    protected override int GetPayloadLength(Transaction transaction)
    {
        ArbitrumUnsignedTransaction unsignedTx = (ArbitrumUnsignedTransaction)transaction;
...
public sealed class ArbitrumContractTxDecoder() : BaseEIP1559TxDecoder<ArbitrumContractTransaction>((TxType)ArbitrumTxType.ArbitrumContract)
{
    public override void Encode(Transaction transaction, RlpStream stream, RlpBehaviors rlpBehaviors = RlpBehaviors.None, bool forSigning = false, bool isEip155Enabled = false, ulong chainId = 0)
    {
        forSigning = true;
    ...
    protected override int GetPayloadLength(Transaction transaction)
    {
        ArbitrumContractTransaction contractTx = (ArbitrumContractTransaction)transaction;
