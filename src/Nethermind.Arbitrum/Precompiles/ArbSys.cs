...
public static class ArbSys
{
    ...
    {
        Dictionary<string, object> data = EventsEncoder.DecodeEvent(L2ToL1TransactionEvent, logEntry);
    ...
    {
        Dictionary<string, object> data = EventsEncoder.DecodeEvent(L2ToL1TxEvent, logEntry);
