...
public static class ArbGasInfo
{
    ...
    // GetMaxTxGasLimit gets the maximum gas limit for a single transaction
    ...
    // GetGasPricingConstraints gets multi-constraint pricing info (stub for now)
