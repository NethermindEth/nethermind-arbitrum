...
public static class PrecompileHelper
{
    ...
    public static bool TryCheckMethodVisibility(IArbitrumPrecompile precompile, uint methodId, ArbitrumPrecompileExecutionContext context, out bool shouldRevert)
        => precompile switch
        {
