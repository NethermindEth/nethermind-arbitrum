...
public class ArbitrumGenesisLoader(INethermindApi api) : IGenesisLoader
{
        ...
        ParsedInitMessage initMessage)
    {
        ...
        // Open the ArbosState instance *after* initial parameters are set
        ArbosState arbosState =
            await ArbosState.OpenArbosStateAsync(worldState, burner, _api.LogManager.GetClassLogger<ArbosState>(), arbitrumConfig, chainSpec);
