...
public abstract class WasmGas
{
    ...
    public static ulong WasmStateLoadCost(ArbitrumVirtualMachine vm, StorageCell storageCell)
    {
        ulong gasCost = 0;
    ...
    public static ulong WasmStateStoreCost(ArbitrumVirtualMachine vm, StorageCell storageCell, ReadOnlySpan<byte> newValue)
    {
