...
public class ArbitrimGethLikeTxTraceConverter : JsonConverter<ArbitrumGethLikeTxTrace>
{
    public override ArbitrumGethLikeTxTrace Read(
        ...
        JsonSerializerOptions options)
    {
        ...
        var trace = new ArbitrumGethLikeTxTrace();
